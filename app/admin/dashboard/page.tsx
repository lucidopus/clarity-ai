    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="w-64 bg-card-bg border-r border-border flex flex-col shrink-0">
        ...
        <div className="p-4 border-t border-border space-y-2">
          ...
          <Button variant="secondary" size="sm" onClick={handleRefresh} className="w-full cursor-pointer">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
            </svg>
            Refresh
          </Button>
          <Button variant="outline" size="sm" onClick={handleLogout} className="w-full cursor-pointer">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
